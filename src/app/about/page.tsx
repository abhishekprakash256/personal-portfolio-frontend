...
const experience_data2: string ='- ##### **Chat App:** Designed and implemented a **hash-based, two-user chat system** with a **Golang backend**, building a production-ready server for authentication, user management, chat rooms, and real-time messaging; integrated **PostgreSQL** as the message store with optimized CRUD APIs, improving database efficiency by **35%** through schema design and query optimization; developed a **responsive, multi-device frontend** and implemented a **polling-based ping-pong mechanism** for real-time server health and connection monitoring.\n - ##### **Tiny URL Generator:** Developed a **full-stack Tiny URL generation service** with complete frontend and backend functionality; utilized **Redis hashes** for fast URL storage and retrieval with collision avoidance; built a **responsive frontend** using **Bootstrap and JavaScript**, and implemented **REST APIs** with **Flask, Redis, and Python** for URL creation and redirection.\n - ##### **Portfolio Website:** Developed a **full-stack portfolio website** using **React, Bootstrap, HTML, and CSS** for the frontend and **Flask with MongoDB** for a robust RESTful backend; containerized the application with **Docker**, automated deployment using **Ansible**, deployed on **AWS EC2**, and configured **NGINX** as a reverse proxy for efficient request handling.'

const experience_data1:string = '- ##### **Performance & Growth Optimization:** Drove major performance improvements, targeting a **30% increase in user engagement**, **45% higher click-through rates**, and a **15% boost in conversion rates**.\n - ##### **SEO & ML-Driven Ranking:** Optimized product and article rankings using **backend machine learning strategies**, keyword optimization, and advanced SEO techniques, elevating organic search position from **6th to 2nd** by category and contributing to a **$5M revenue increase**.\n - ##### **Technical Leadership & Automation:** Led a **10-member technical team** to deploy an online marketing campaign for a playground construction project; streamlined contract assignments by integrating **Zoho CRM** and automating **Excel-based reporting**, and enhanced backend workflows using **Python and AWS** for efficient gallery uploads, resulting in a **37% revenue increase** and **68% growth in site CTR**, supported by **Google Analytics and SEMrush**.\n - ##### **Performance Audits & Optimization:** Conducted regular audits of **50+ plugins** to ensure peak website performance and system stability.\n - ##### **Catalog & UX Improvements:** Enhanced product filtering with a robust plugin-based sorting system, improving catalog navigation speed by **45%** for internal teams and customers.\n - ##### **Testing & CI/CD:** Executed comprehensive testing using **GitLab CI/CD, Selenium, Ansible, and Python** to validate filtering efficiency and improve the customer checkout experience.'

const experience_data5:string = '- ##### **Data Engineering & ETL Pipelines:** Designed and prototyped **production-grade ETL pipelines** using **DLT Hub, DuckDB, and Dagster** to ingest and transform API data into a scalable data warehouse.\n - #### **Incremental Data Processing:** Built and optimized **incremental data update pipelines** leveraging the **Microsoft Graph API (SharePoint)**, improving pipeline efficiency by **45%**.\n - ##### **Pipeline Performance Optimization:** Optimized data ingestion and transformation workflows through **batching, caching, and query tuning**, reducing end-to-end pipeline runtime by **40%**.\n - ##### **Automated Reporting Systems:** Developed a **fully automated donor reporting system** using **Python, Pandas, and Matplotlib**, increasing reporting efficiency by **75%** and eliminating manual workflows.'

const experience_data6: string = '- ##### **Legacy System Modernization:** Modernized a legacy application by refactoring **PHP backend logic** and migrating **jQuery-based frontend components to Vanilla JavaScript**, resulting in a cleaner architecture with improved performance, maintainability, and long-term scalability.'
...
<MarkDown mark_down_data="## Backend Engineer - Florida State University"></MarkDown>

<MarkDown mark_down_data={experience_data6}/>


<MarkDown mark_down_data="## Data Analyst - GoodWill BigBend Industries"></MarkDown>

<MarkDown mark_down_data={experience_data5}/>
